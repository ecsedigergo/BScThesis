 ...
 *   <li>{@link hu.bme.mit.depModel.impl.ActionDecImpl#getPortType <em>Port Type</em>}</li>
...
public class ActionDecImpl extends TransitionFeatureDecImpl implements ActionDec
{
  ...
  public Port getPortType()
  {
    if (portType != null && portType.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DepModelPackage.ACTION_DEC__PORT_TYPE, oldPortType, portType));
      }
    }
    return portType;
  }
  ...
  public void setPortType(Port newPortType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DepModelPackage.ACTION_DEC__PORT_TYPE, oldPortType, portType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DepModelPackage.ACTION_DEC__NAME:
        return getName();
      case DepModelPackage.ACTION_DEC__PORT_TYPE:
