 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.errorModel.impl.TransitionStateImpl#getSourceState <em>Source State</em>}</li>
 *   <li>{@link hu.bme.mit.errorModel.impl.TransitionStateImpl#getTargetState <em>Target State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionStateImpl extends TransitionFeatureDecImpl implements TransitionState
{
  ...
  {
    return ErrorModelPackage.Literals.TRANSITION_STATE;
  }
    ...
    if (sourceState != null && sourceState.eIsProxy())
    {
      ...
      if (sourceState != oldSourceState)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ErrorModelPackage.TRANSITION_STATE__SOURCE_STATE, oldSourceState, sourceState));
      }
    }
    return sourceState;
  }
  ...
  public void setSourceState(StateDec newSourceState)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.TRANSITION_STATE__SOURCE_STATE, oldSourceState, sourceState));
  }
  ...
  public StateDec getTargetState()
  {
    if (targetState != null && targetState.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ErrorModelPackage.TRANSITION_STATE__TARGET_STATE, oldTargetState, targetState));
      }
    }
    return targetState;
  }
  ...
  public void setTargetState(StateDec newTargetState)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.TRANSITION_STATE__TARGET_STATE, oldTargetState, targetState));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ErrorModelPackage.TRANSITION_STATE__SOURCE_STATE:
        if (resolve) return getSourceState();
        return basicGetSourceState();
      case ErrorModelPackage.TRANSITION_STATE__TARGET_STATE:
