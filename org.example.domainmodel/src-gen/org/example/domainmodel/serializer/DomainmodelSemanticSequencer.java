...
public class DomainmodelSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == DomainmodelPackage.eINSTANCE)
			...
			case DomainmodelPackage.IMPORT:
				...
				return; 
			case DomainmodelPackage.PACKAGE_DEC:
				sequence_PackageDec(context, (PackageDec) semanticObject); 
				return; 
			}
	...
	protected void sequence_Import(ISerializationContext context, Import semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.IMPORT__IMPORTED_NAME_SPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.IMPORT__IMPORTED_NAME_SPACE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	/**
	 * Contexts:
	 *     AbstractElement returns PackageDec
	 *     PackageDec returns PackageDec
	 *
	 * Constraint:
	 *     (name=QualifiedName element+=AbstractElement*)
	 */
	protected void sequence_PackageDec(ISerializationContext context, PackageDec semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
