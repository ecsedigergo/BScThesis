...
@after {
	...
	(
		...
		{
			$current = $this_PackageDec_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRulePackageDec returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPackageDecRule()); }
	iv_rulePackageDec=rulePackageDec
	{ $current=$iv_rulePackageDec.current; }
	EOF;

// Rule PackageDec
rulePackageDec returns [EObject current=null]
@init {
	enterRule();
}
@after {
