...
public class DomainmodelAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected DomainmodelSwitch<Adapter> modelSwitch =
    new DomainmodelSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter casePackageDec(PackageDec object)
      {
        return createPackageDecAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.example.domainmodel.domainmodel.PackageDec <em>Package Dec</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createPackageDecAdapter()
  {
    return null;
  }
