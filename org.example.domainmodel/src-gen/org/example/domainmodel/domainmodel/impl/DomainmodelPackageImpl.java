...
public class DomainmodelPackageImpl extends EPackageImpl implements DomainmodelPackage
{
   ...
   * @generated
   */
  private EClass packageDecEClass = null;
   ...
   * @generated
   */
  public EClass getPackageDec()
  {
    return packageDecEClass;
  }
   ...
   * @generated
   */
  public EAttribute getPackageDec_Name()
  {
    return (EAttribute)packageDecEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getPackageDec_Element()
  {
    return (EReference)packageDecEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    packageDecEClass = createEClass(PACKAGE_DEC);
    createEAttribute(packageDecEClass, PACKAGE_DEC__NAME);
    createEReference(packageDecEClass, PACKAGE_DEC__ELEMENT);
  ...
  public void initializePackageContents()
  {
    ...
    packageDecEClass.getESuperTypes().add(this.getAbstractElement());
    ...
    initEClass(packageDecEClass, PackageDec.class, "PackageDec", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getPackageDec_Name(), ecorePackage.getEString(), "name", null, 0, 1, PackageDec.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getPackageDec_Element(), this.getAbstractElement(), null, "element", null, 0, -1, PackageDec.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
