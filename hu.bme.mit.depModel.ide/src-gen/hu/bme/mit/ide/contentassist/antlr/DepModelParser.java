	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getAbstractModelDecAccess().getAlternatives(), "rule__AbstractModelDec__Alternatives");
					...
					put(grammarAccess.getErrorModelAccess().getGroup(), "rule__ErrorModel__Group__0");
					...
					put(grammarAccess.getDepModelAccess().getDepmodelsAssignment(), "rule__DepModel__DepmodelsAssignment");
					...
					put(grammarAccess.getErrorModelAccess().getNameAssignment_2(), "rule__ErrorModel__NameAssignment_2");
					put(grammarAccess.getErrorModelAccess().getEmodelElementsAssignment_4(), "rule__ErrorModel__EmodelElementsAssignment_4");
					...
					put(grammarAccess.getTriggerDecAccess().getPortTypeAssignment_2(), "rule__TriggerDec__PortTypeAssignment_2");
					put(grammarAccess.getTriggerDecAccess().getErrorModeAssignment_3(), "rule__TriggerDec__ErrorModeAssignment_3");
					put(grammarAccess.getActionDecAccess().getNameAssignment_1(), "rule__ActionDec__NameAssignment_1");
					put(grammarAccess.getActionDecAccess().getPortTypeAssignment_2(), "rule__ActionDec__PortTypeAssignment_2");
					put(grammarAccess.getActionDecAccess().getErrorModeAssignment_3(), "rule__ActionDec__ErrorModeAssignment_3");
					...
					put(grammarAccess.getComponentTypeAccess().getCompFeaturesAssignment_4(), "rule__ComponentType__CompFeaturesAssignment_4");
					put(grammarAccess.getInPortAccess().getNameAssignment_3(), "rule__InPort__NameAssignment_3");
					put(grammarAccess.getInPortAccess().getSuperTypeAssignment_5(), "rule__InPort__SuperTypeAssignment_5");
					put(grammarAccess.getOutPortAccess().getNameAssignment_3(), "rule__OutPort__NameAssignment_3");
