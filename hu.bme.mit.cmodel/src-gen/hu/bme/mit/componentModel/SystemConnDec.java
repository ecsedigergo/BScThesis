 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.componentModel.SystemConnDec#getName <em>Name</em>}</li>
...
public interface SystemConnDec extends AbstractElement
{
   ...
   * @see #setName(String)
   * @see hu.bme.mit.componentModel.ComponentModelPackage#getSystemConnDec_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link hu.bme.mit.componentModel.SystemConnDec#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
