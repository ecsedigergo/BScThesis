...
public class errorModesImpl extends MinimalEObjectImpl.Container implements errorModes
{
  ...
  {
    return ComponentModelPackage.Literals.ERROR_MODES;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComponentModelPackage.ERROR_MODES__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ComponentModelPackage.ERROR_MODES__NAME:
        return getName();
    }
