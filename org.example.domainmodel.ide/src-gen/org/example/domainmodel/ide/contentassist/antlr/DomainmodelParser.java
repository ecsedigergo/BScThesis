		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPackageDecAccess().getGroup(), "rule__PackageDec__Group__0");
					...
					put(grammarAccess.getPackageDecAccess().getNameAssignment_1(), "rule__PackageDec__NameAssignment_1");
					put(grammarAccess.getPackageDecAccess().getElementAssignment_3(), "rule__PackageDec__ElementAssignment_3");
